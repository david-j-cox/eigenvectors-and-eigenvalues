...
- Participants fitted: 23 / 23
- Held-out skill vs persistence (A_i): 0.505 [0.426, 0.539]
...
|---|---|
| diff_color_same_contingency | 0.667 |
| same_color_diff_contingency | 0.630 |

Participants whose dynamics follow the contingency rather than the color: 70%
...
- Perturbations delivered: 174 (8 per participant)
