...
export const CONTINGENCIES: Record<string, ContingencySpec> = {
  A_rich: {
    ...
    viAMs: 1000,
    viBMs: 4000,
    recoveryAPerResponse: 0.086,
    recoveryBPerResponse: 0.036,
    label: 'A-rich',
  },
  B_rich: {
    id: 'B_rich',
    viAMs: 4000,
    viBMs: 1000,
    recoveryAPerResponse: 0.036,
    recoveryBPerResponse: 0.086,
    label: 'B-rich',
  },
  symmetric: {
    id: 'symmetric',
    viAMs: 1600,
    viBMs: 1600,
    recoveryAPerResponse: 0.061,
    recoveryBPerResponse: 0.061,
    label: 'Symmetric',
  },
};
